...
setTimeout(function (){var lD = document.getElementById('loadD');lD.style.transform='scale(0)';lD.style.backgroundColor='#4fc3f7';lD.firstElementChild.style.display='none';
