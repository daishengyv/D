...
$('#dai').hover(function (){ this.style['box-shadow'] = '-2px -5px 30px 5px rgba(255,255,255,0.5)';
document.addEventListener('mousemove', _dai);},function (){  $('#dai').css({
...
setTimeout(function (){
  ...
  setTimeout(function (){
     ...
     setTimeout(function (){$pagew .style.display = 'none';},800);
    },1000);
},3000);
}
